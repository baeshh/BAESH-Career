            ...
            <div className="slide-fade">
              ...
              <div className="field" style={{ marginTop: 16 }}>
                ...
                {email && emailDisposable && (
                  <div className="error-text">
                    임시/디스포저블 메일은 사용할 수 없어요.
                  </div>
                )}
                {!emailDisposable && (
                  <div className="helper">
                    회사나 자주 쓰는 이메일을 입력해 주세요.
                  </div>
                )}
              </div>
              ...
              <div className="panel" style={{ padding: 12 }}>
                ...
                <div style={{ display: "grid", gap: 8, marginTop: 8 }}>
                  <input
                    className={`input ${phone && !phoneValid ? "error" : ""}`}
                    placeholder=" "
                    value={phone}
                  ...
                  {!phoneVerified && (
                    <div className="helper">
                      코드를 보냈어요. 5분 내에 입력해 주세요.
                    </div>
                  )}
                  <div className="helper">예: 010-1234-5678</div>
                  {phone && !phoneValid && (
                    <div className="error-text">
                      한국 휴대폰 번호 형식으로 입력해 주세요.
                    </div>
                  )}
                </div>
              </div>
              ...
              >
                ...
                >
                  {submitting ? "클론 생성 중…" : "AI 클론 생성 시작하기"}
                </button>
              </div>
